...
namespace adventofcode2019.Days
{
    public class Day9 : IProblem
    {
        ...
        public long Answer(params long[] arguments)
        {
            ...
            //Day 1
            icp2 = new IntCodeProcessor2(program) {Debug = false, InputModeSetting = IntCodeProcessor2.InputMode.Set, InputNumbers = { 1 } };

            icp2.Run();

            // Day 2
            icp2 = new IntCodeProcessor2(program) { Debug = false, InputModeSetting = IntCodeProcessor2.InputMode.Set, InputNumbers = { 2 } };

            icp2.Run();

            // Tests
            bool debug = false;
            icp2 = new IntCodeProcessor2(test1) { Debug = debug };
            icp2.Run();

            icp2 = new IntCodeProcessor2(test2) { Debug = debug };
            icp2.Run();

            icp2 = new IntCodeProcessor2(test3) { Debug = debug };
            icp2.Run();

            icp2 = new IntCodeProcessor2(test4) { Debug = debug };
            icp2.Run();

            icp2 = new IntCodeProcessor2(test5) { Debug = debug };
            icp2.Run();

            icp2 = new IntCodeProcessor2(test6) { Debug = debug };
            icp2.Run();

            icp2 = new IntCodeProcessor2(test7) { Debug = debug, InputModeSetting = IntCodeProcessor2.InputMode.Set, InputNumbers = { 32 } };
            icp2.Run();

            icp2 = new IntCodeProcessor2(test8) { Debug = debug, InputModeSetting = IntCodeProcessor2.InputMode.Set, InputNumbers = { 32 } };
            icp2.Run();
