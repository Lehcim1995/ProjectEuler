...
namespace adventofcode2019.Days
{
    public class Day17 : IProblem
    {
        ...
        {
            icp2 = new IntCodeProcessor2(program) { InputModeSetting = IntCodeProcessor2.InputMode.Console };
            ...
            {
                bool up = map.TryGetValue(m.Key + new Point(0, 1), out int v) ? v == '#' : false;
                bool down = map.TryGetValue(m.Key + new Point(0, -1), out int v2) ? v2 == '#' : false;
                bool left = map.TryGetValue(m.Key + new Point(1, 0), out int v3) ? v3 == '#' : false;
                bool right = map.TryGetValue(m.Key + new Point(-1, 0), out int v4) ? v4 == '#' : false;
