...
public class problem107 { //https://projecteuler.net/problem=107
...
"774,289,833,257,-  ,381,239,722,711,468,933,-,-,17,-,-,148,-,-,853,-,-,-,-,264,194,260,947,-,752,147,-,-,343,112,273,344,680,540,-"};
    ...
    private int[,] newtwork2 = new int[40,40];

    public int solve()
    {
        populate();

        Console.WriteLine(sum(newtwork2));
    ...
    private void populate()
    {
        ...
        {
            string[] numbers = network[i].Split(",");

            for(int j = 0; j < numbers.Length; j++)
            {
                newtwork2[j,i] = num(numbers[j]);
            }
        }
    }

    private int sum(int[,] net)
    {
        int sum = 0;

        foreach(int num in net)
        {
            if (num == -1)
            {
                continue;
